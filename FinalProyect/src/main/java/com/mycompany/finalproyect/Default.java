...
public class Default {
    ...
    static boolean daily = true, week = false;
    ...
    public static Trophies[] defaultTrophies(){
        ...
        trophies1[2] = new Trophies("Hacer 30 reviews", 20, 1, 5);
        trophies1[3] = new Trophies("Hacer 40 reviews", 20, 1, 5);
        trophies1[4] = new Trophies("Hacer 50 reviews", 20, 1, 10);
        trophies1[5] = new Trophies("Hacer 60 reviews", 20, 1, 10);
        ...
        trophies1[13] = new Trophies("Reservar 40 entradas", 20, 2, 5);
        trophies1[14] = new Trophies("Reservar 50 entradas", 20, 2, 10);
        trophies1[15] = new Trophies("Reservar 60 entradas", 20, 2, 10);
        trophies1[16] = new Trophies("Reservar 70 entradas", 20, 2, 10);
        trophies1[17] = new Trophies("Reservar 80 entradas", 20, 2, 10);
        trophies1[18] = new Trophies("Reservar 90 entradas", 20, 2, 10);
        trophies1[19] = new Trophies("Reservar 100 entradas", 20, 2, 20);
        trophies1[20] = new Trophies("Leer 10 infos", 10, 3, 5);
        trophies1[21] = new Trophies("Leer 20 infos", 20, 3, 5);
        trophies1[22] = new Trophies("Leer 30 infos", 20, 3, 5);
        trophies1[23] = new Trophies("Leer 40 infos", 20, 3, 5);
        trophies1[24] = new Trophies("Leer 50 infos", 20, 3, 10);
        trophies1[25] = new Trophies("Leer 60 infos", 20, 3, 10);
        trophies1[26] = new Trophies("Leer 70 infos", 20, 3, 10);
        trophies1[27] = new Trophies("Leer 80 infos", 20, 3, 10);
        trophies1[28] = new Trophies("Leer 90 infos", 20, 3, 10);
        trophies1[29] = new Trophies("Leer 100 infos", 20, 3, 20);
        return trophies1;
    }
